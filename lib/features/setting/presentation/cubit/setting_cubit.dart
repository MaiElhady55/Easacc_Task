...
Future<void> printReceipt() async {
  ...
  try {
    ...
    bytes += generator.hr();
    bytes += generator.text('Customer: John Doe', styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('Invoice: #12345', styles: const PosStyles(align: PosAlign.left));
    bytes += generator.text('Amount: \$100.00', styles: const PosStyles(align: PosAlign.left));
    bytes += generator.hr();
    bytes += generator.text(
